...
file_path = r'C:\Users\slangston1\titan\nrl_data_main\data\NRL\combined_nrl_data.xlsx'
combined_nrl_data = pd.read_excel(file_path)
...
output_file = r'C:\Users\slangston1\titan\nrl_data_main\data\NRL\combined_nrl_data_imputed.xlsx'
combined_nrl_data.to_excel(output_file, index=False)
