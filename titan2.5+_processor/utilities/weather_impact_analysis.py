...
def main():
    ...
    if df[['temperature_C', 'precipitation_mm', 'wind_speed_kmh', 'wind_direction_deg', 'humidity_percent']].isnull().all().all():
        print("[WARN] No weather data fetched. No matches found in the next 7 days or API returned no data.")
